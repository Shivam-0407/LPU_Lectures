...
public class CustomGenericArrayLists<T> {  //we're simply providing u a template in which "T" can be of any type
                                  //<String>
    private Object []data;
...
//        arr2.isEmpty();
        ...
        CustomGenericArrayLists<Integer> arr3 = new CustomGenericArrayLists<>();
        for(int i=0;i<10;i++){
            arr3.add(i);
        }
        ...
        CustomGenericArrayLists<String> st = new CustomGenericArrayLists<>();
        st.add("Striinggg");
    }
